...
public class ArmorMaterialDiamondObsidian implements ArmorMaterial {
    ...
    public int getDurability(ArmorItem.Type type) {
        return BASE_DURABILITY[type.getEquipmentSlot().getEntitySlotId()] * 38;
    }
